...
# --- Datapoint 1 ---
echo "Applying 78 Mbps, 4 ms, Loss: 24.0000% with dualpi2"
...
# --- Datapoint 2 ---
echo "Applying 15 Mbps, 4 ms, Loss: 38.0000% with dualpi2"
...
# --- Datapoint 3 ---
echo "Applying 7 Mbps, 5 ms, Loss: 42.0000% with dualpi2"
...
# --- Datapoint 4 ---
echo "Applying 9 Mbps, 5 ms, Loss: 41.0000% with dualpi2"
...
# --- Datapoint 5 ---
echo "Applying 347 Mbps, 4 ms, Loss: 4.0000% with dualpi2"
...
# --- Datapoint 6 ---
echo "Applying 89 Mbps, 4 ms, Loss: 23.0000% with dualpi2"
...
# --- Datapoint 7 ---
echo "Applying 43 Mbps, 4 ms, Loss: 31.0000% with dualpi2"
...
# --- Datapoint 8 ---
echo "Applying 12 Mbps, 5 ms, Loss: 40.0000% with dualpi2"
...
# --- Datapoint 9 ---
echo "Applying 203 Mbps, 4 ms, Loss: 11.0000% with dualpi2"
...
# --- Datapoint 10 ---
echo "Applying 14 Mbps, 4 ms, Loss: 39.0000% with dualpi2"
...
# --- Datapoint 11 ---
echo "Applying 603 Mbps, 5 ms, Loss: 0.0000% with dualpi2"
...
# --- Datapoint 12 ---
echo "Applying 17 Mbps, 5 ms, Loss: 38.0000% with dualpi2"
...
# --- Datapoint 13 ---
echo "Applying 13 Mbps, 5 ms, Loss: 39.0000% with dualpi2"
...
# --- Datapoint 14 ---
echo "Applying 79 Mbps, 4 ms, Loss: 24.0000% with dualpi2"
...
# --- Datapoint 15 ---
echo "Applying 52 Mbps, 4 ms, Loss: 29.0000% with dualpi2"
...
# --- Datapoint 16 ---
echo "Applying 11 Mbps, 4 ms, Loss: 40.0000% with dualpi2"
...
# --- Datapoint 17 ---
echo "Applying 8 Mbps, 4 ms, Loss: 42.0000% with dualpi2"
...
# --- Datapoint 18 ---
echo "Applying 111 Mbps, 4 ms, Loss: 20.0000% with dualpi2"
...
# --- Datapoint 19 ---
echo "Applying 11 Mbps, 5 ms, Loss: 40.0000% with dualpi2"
...
# --- Datapoint 20 ---
echo "Applying 601 Mbps, 5 ms, Loss: 0.0000% with dualpi2"
...
# --- Datapoint 21 ---
echo "Applying 40 Mbps, 5 ms, Loss: 31.0000% with dualpi2"
...
# --- Datapoint 23 ---
echo "Applying 277 Mbps, 4 ms, Loss: 6.0000% with dualpi2"
...
# --- Datapoint 24 ---
echo "Applying 50 Mbps, 4 ms, Loss: 29.0000% with dualpi2"
...
# --- Datapoint 25 ---
echo "Applying 324 Mbps, 5 ms, Loss: 4.0000% with dualpi2"
...
# --- Datapoint 26 ---
echo "Applying 31 Mbps, 4 ms, Loss: 34.0000% with dualpi2"
...
# --- Datapoint 27 ---
echo "Applying 192 Mbps, 4 ms, Loss: 12.0000% with dualpi2"
...
# --- Datapoint 28 ---
echo "Applying 20 Mbps, 5 ms, Loss: 37.0000% with dualpi2"
...
# --- Datapoint 29 ---
echo "Applying 431 Mbps, 5 ms, Loss: 2.0000% with dualpi2"
...
# --- Datapoint 30 ---
echo "Applying 16 Mbps, 5 ms, Loss: 38.0000% with dualpi2"
...
# --- Datapoint 32 ---
echo "Applying 154 Mbps, 4 ms, Loss: 15.0000% with dualpi2"
...
# --- Datapoint 33 ---
echo "Applying 897 Mbps, 4 ms, Loss: 0.0000% with dualpi2"
...
# --- Datapoint 35 ---
echo "Applying 58 Mbps, 4 ms, Loss: 28.0000% with dualpi2"
...
# --- Datapoint 36 ---
echo "Applying 198 Mbps, 4 ms, Loss: 11.0000% with dualpi2"
...
# --- Datapoint 37 ---
echo "Applying 351 Mbps, 5 ms, Loss: 3.0000% with dualpi2"
...
# --- Datapoint 38 ---
echo "Applying 264 Mbps, 5 ms, Loss: 7.0000% with dualpi2"
...
# --- Datapoint 39 ---
echo "Applying 513 Mbps, 5 ms, Loss: 1.0000% with dualpi2"
...
# --- Datapoint 40 ---
echo "Applying 29 Mbps, 4 ms, Loss: 34.0000% with dualpi2"
...
# --- Datapoint 41 ---
echo "Applying 105 Mbps, 4 ms, Loss: 21.0000% with dualpi2"
...
# --- Datapoint 42 ---
echo "Applying 12 Mbps, 4 ms, Loss: 40.0000% with dualpi2"
...
# --- Datapoint 43 ---
echo "Applying 53 Mbps, 5 ms, Loss: 29.0000% with dualpi2"
...
# --- Datapoint 44 ---
echo "Applying 109 Mbps, 4 ms, Loss: 20.0000% with dualpi2"
...
# --- Datapoint 45 ---
echo "Applying 802 Mbps, 4 ms, Loss: 0.0000% with dualpi2"
...
# --- Datapoint 46 ---
echo "Applying 602 Mbps, 5 ms, Loss: 0.0000% with dualpi2"
...
# --- Datapoint 47 ---
echo "Applying 246 Mbps, 5 ms, Loss: 8.0000% with dualpi2"
...
# --- Datapoint 48 ---
echo "Applying 358 Mbps, 5 ms, Loss: 3.0000% with dualpi2"
...
# --- Datapoint 49 ---
echo "Applying 74 Mbps, 4 ms, Loss: 25.0000% with dualpi2"
...
# --- Datapoint 50 ---
echo "Applying 77 Mbps, 4 ms, Loss: 25.0000% with dualpi2"
...
# --- Datapoint 52 ---
echo "Applying 77 Mbps, 4 ms, Loss: 24.0000% with dualpi2"
...
# --- Datapoint 53 ---
echo "Applying 71 Mbps, 4 ms, Loss: 26.0000% with dualpi2"
...
# --- Datapoint 54 ---
echo "Applying 362 Mbps, 5 ms, Loss: 3.0000% with dualpi2"
...
# --- Datapoint 55 ---
echo "Applying 387 Mbps, 5 ms, Loss: 2.0000% with dualpi2"
...
# --- Datapoint 56 ---
echo "Applying 599 Mbps, 5 ms, Loss: 0.0000% with dualpi2"
...
# --- Datapoint 57 ---
echo "Applying 808 Mbps, 4 ms, Loss: 0.0000% with dualpi2"
...
# --- Datapoint 58 ---
echo "Applying 202 Mbps, 4 ms, Loss: 11.0000% with dualpi2"
...
# --- Datapoint 59 ---
echo "Applying 295 Mbps, 4 ms, Loss: 6.0000% with dualpi2"
...
# --- Datapoint 61 ---
echo "Applying 94 Mbps, 4 ms, Loss: 22.0000% with dualpi2"
