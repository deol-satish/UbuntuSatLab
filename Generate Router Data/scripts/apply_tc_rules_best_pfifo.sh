...
# --- Datapoint 1 ---
echo "Applying 244 Mbps, 4 ms, Loss: 8.0000% with pfifo"
...
# --- Datapoint 2 ---
echo "Applying 632 Mbps, 4 ms, Loss: 0.0000% with pfifo"
...
# --- Datapoint 3 ---
echo "Applying 248 Mbps, 5 ms, Loss: 8.0000% with pfifo"
...
# --- Datapoint 4 ---
echo "Applying 214 Mbps, 5 ms, Loss: 10.0000% with pfifo"
...
# --- Datapoint 5 ---
echo "Applying 839 Mbps, 4 ms, Loss: 0.0000% with pfifo"
...
# --- Datapoint 6 ---
echo "Applying 246 Mbps, 4 ms, Loss: 8.0000% with pfifo"
...
# --- Datapoint 7 ---
echo "Applying 241 Mbps, 4 ms, Loss: 8.0000% with pfifo"
...
# --- Datapoint 9 ---
echo "Applying 238 Mbps, 4 ms, Loss: 9.0000% with pfifo"
...
# --- Datapoint 10 ---
echo "Applying 226 Mbps, 4 ms, Loss: 9.0000% with pfifo"
...
# --- Datapoint 14 ---
echo "Applying 1156 Mbps, 4 ms, Loss: 0.0000% with pfifo"
...
# --- Datapoint 16 ---
echo "Applying 248 Mbps, 4 ms, Loss: 8.0000% with pfifo"
...
# --- Datapoint 17 ---
echo "Applying 220 Mbps, 4 ms, Loss: 10.0000% with pfifo"
...
# --- Datapoint 18 ---
echo "Applying 1391 Mbps, 4 ms, Loss: 0.0000% with pfifo"
...
# --- Datapoint 23 ---
echo "Applying 249 Mbps, 4 ms, Loss: 8.0000% with pfifo"
...
# --- Datapoint 27 ---
echo "Applying 247 Mbps, 4 ms, Loss: 8.0000% with pfifo"
...
# --- Datapoint 36 ---
echo "Applying 243 Mbps, 4 ms, Loss: 8.0000% with pfifo"
...
# --- Datapoint 39 ---
echo "Applying 249 Mbps, 5 ms, Loss: 8.0000% with pfifo"
...
# --- Datapoint 42 ---
echo "Applying 217 Mbps, 4 ms, Loss: 10.0000% with pfifo"
...
# --- Datapoint 43 ---
echo "Applying 598 Mbps, 5 ms, Loss: 0.0000% with pfifo"
...
# --- Datapoint 44 ---
echo "Applying 245 Mbps, 4 ms, Loss: 8.0000% with pfifo"
...
# --- Datapoint 53 ---
echo "Applying 242 Mbps, 4 ms, Loss: 8.0000% with pfifo"
...
# --- Datapoint 59 ---
echo "Applying 222 Mbps, 4 ms, Loss: 10.0000% with pfifo"
